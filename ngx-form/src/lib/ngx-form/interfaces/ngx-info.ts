...
export const NgxFieldInputInfo: { [key in NgxFormInputs['type']]: INgxFieldInputInfo } = {
    ...
    COORDINATES: { title: 'موقعیت جغرافیایی', methods: new NgxFormInputCoordinatesMethods() },
    ...
    GROUP: { title: 'گروه', methods: new NgxFormInputGroupMethods() },
    IP: { title: 'آدرس آی‌پی', methods: new NgxFormInputIpMethods() },
    ICON: { title: 'آیکون', methods: new NgxFormInputIconMethods() },
    LIST: { title: 'لیست مقادیر', methods: new NgxFormInputListMethods() },
    MASK: { title: 'فرمت عددی', methods: new NgxFormInputMaskMethods() },
