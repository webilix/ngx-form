...
export const NumberInputs: NgxFormRow[] = [
    ...
    { name: 'number-6', type: 'NUMBER', title: 'مقدار اعشاری با ۵ رقم بعد از اعشار', optional: true, decimal: 5 },
    {
        name: 'number-7',
        type: 'NUMBER',
        title: 'غیرفعال شدن',
    ...
    { name: 'number-9', type: 'NUMBER', title: 'محدودیت مقدار', optional: true, minimum: 10, maximum: 2000 },
    { name: 'number-10', type: 'NUMBER', title: 'مضارب ۱۰', optional: true, multiplyOf: 10 },
    { name: 'number-11', type: 'NUMBER', title: 'نمایش حروف', optional: true, text: 'LETTER' },
    {
        name: 'number-12',
        type: 'NUMBER',
    ...
    { name: 'number-13', type: 'NUMBER', title: 'نمایش ساعت', optional: true, text: 'HOUR' },
    { name: 'number-14', type: 'NUMBER', title: 'نمایش دقیقه', optional: true, text: 'MINUTE' },
    { name: 'number-15', type: 'NUMBER', title: 'نمایش ثانیه', optional: true, text: 'SECOND' },
    {
        name: 'number-16',
        type: 'NUMBER',
