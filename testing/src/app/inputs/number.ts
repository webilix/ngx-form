...
export const NumberInputs: NgxFormRow[] = [
    ...
    { name: 'number-10', type: 'NUMBER', title: 'نمایش حروف', optional: true, text: 'LETTER' },
    {
        name: 'number-11',
        type: 'NUMBER',
    ...
    { name: 'number-12', type: 'NUMBER', title: 'نمایش ساعت', optional: true, text: 'HOUR' },
    { name: 'number-13', type: 'NUMBER', title: 'نمایش دقیقه', optional: true, text: 'MINUTE' },
    { name: 'number-14', type: 'NUMBER', title: 'نمایش ثانیه', optional: true, text: 'SECOND' },
    {
        name: 'number-15',
        type: 'NUMBER',
