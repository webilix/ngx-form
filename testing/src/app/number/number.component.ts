    ...
    public ngxForm: INgxForm = {
        ...
        inputs: [
            ...
            { name: 'number-4', type: 'NUMBER', title: 'مقدار اعشاری', optional: true, decimal: true },
            {
                ...
                title: 'غیرفعال شدن',
                optional: true,
                disableOn: (values: INgxFormValues) => values['number-2'] === 10,
                hint: 'در صورتی که مقدار اختیاری 10 باشد این گزینه غیرفعال می‌شود.',
            },
            {
                name: 'number-6',
                type: 'NUMBER',
                title: 'عدم نمایش',
                optional: true,
                hideOn: (values: INgxFormValues) => values['number-2'] === 20,
                hint: 'در صورتی که مقدار اختیاری 20 باشد این گزینه نمایش داده نمی‌شود.',
            },
